...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Firefox(
            firefox_profile=firefoxProfile, executable_path=r"C:\Users\Pedro Henrique\Downloads\geckdriver\geckodriver.exe"
        )
    ...
    def comente_nas_fotos_com_a_hashtag(self, hashtag):
        ...
        for pic_href in links_de_posts:
            ...
            try:
                comments = [
                    "Me sigan no instagram adoro homens mais velhos",
                    "Me chamem no direct respondo todos",
                    "Tenho uma surpresinha pra vocês no privado",
                    "Quem quer ver foto da minha bunda hoje?",
...
jhonatanBot = InstagramBot("Seuemail", "suasenha")
jhonatanBot.login()